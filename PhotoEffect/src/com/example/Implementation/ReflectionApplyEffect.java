...
public class ReflectionApplyEffect extends BasicApplyEffect implements ApplyEffect {

	public ReflectionApplyEffect(MainActivity mainActivity){
		super(mainActivity);
